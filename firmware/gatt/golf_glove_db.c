...
const uint8_t gatt_database[] = // Define GATT database
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_GOLF_GLOVE, __UUID_GOLF_GLOVE),
        ...
        CHARACTERISTIC_UUID128 (HDLC_GOLF_GLOVE_REALTIME_ENABLED, HDLC_GOLF_GLOVE_REALTIME_ENABLED_VALUE,
            __UUID_GOLF_GLOVE_REALTIME_ENABLED, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_NOTIFY | LEGATTDB_CHAR_PROP_INDICATE,
            LEGATTDB_PERM_READABLE),

            /* Descriptor 'Client Characteristic Configuration' */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_GOLF_GLOVE_REALTIME_ENABLED_CLIENT_CONFIGURATION,
                UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ | LEGATTDB_PERM_AUTH_WRITABLE),
