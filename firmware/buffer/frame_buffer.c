...
wiced_result_t frame_buffer_push_frame(sensor_frame* frame) {
    wiced_result_t result = wiced_rtos_push_to_queue(_frame_buffer, frame,
            FRAME_BUFFER_TIMEOUT);
    return result;
}

wiced_result_t frame_buffer_pop_frame(sensor_frame* frame) {
    wiced_result_t result = wiced_rtos_pop_from_queue(_frame_buffer, frame,
            FRAME_BUFFER_TIMEOUT);
    return result;
}
